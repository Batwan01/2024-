...
csv_file_path = '/data/ephemeral/home/jiwan/2024-Autonomous-Driving-Artificial-Intelligence-Challenge/ensemble/output/csv/co_dino_swin_l_o365_custom_2048_oversampling_val.csv'  # CSV 파일 경로
image_folder_path = '/data/ephemeral/home/dataset/val/images'  # 원본 이미지 폴더 경로
output_folder_path = '/data/ephemeral/home/jiwan/2024-Autonomous-Driving-Artificial-Intelligence-Challenge/visualize/prec_img'  # 시각화된 이미지를 저장할 폴더 경로
